...
This is sometimes called HL for \emph{hypotenuse-leg}.  
...
and we said that in the special case where $b$ meets the opposing side in a right angle, that SSA is enough to prove congruence.  Call if HL to be safe, but it does work.
