...
Euclid \hyperref[sec:Euclid5]{\textbf{Prop $I.5$}} and \hyperref[sec:Euclid6]{\textbf{Prop $I.6$}} are so useful, they have been placed earlier in the book.
...
The external angle theorem is extremely useful, so let's take a break from Euclid and prove it now.  
