...
$\angle PSR$ is a right angle.  

Proof:  

The perpendicular bisector to any chord is parallel to the tangent at the point where it intersects the circle.

Alternatively, we simply appeal to symmetry, or point out the congruent triangles.  Since $\phi = \theta/2$, we have SAS.
